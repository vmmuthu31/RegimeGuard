...
import { FaChevronDown, FaBitcoin, FaEthereum, FaArrowLeft } from "react-icons/fa";
...
export function MarketSwitcher({ currentSymbol }: MarketSwitcherProps) {
  ...
  return (
    <div className="flex items-center gap-3">
      <Link
        href="/dashboard"
        className="w-10 h-10 flex items-center justify-center rounded-full border border-white/20 bg-zinc-950/40 text-zinc-400 hover:text-emerald-400 hover:border-emerald-500/40 transition-all shadow-xl active:scale-95 group/back"
